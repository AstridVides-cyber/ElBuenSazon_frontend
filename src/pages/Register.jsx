...
import { FaFacebook, FaUser, FaLock } from "react-icons/fa";
...
export default function Register() {
    ...
    return (
        ...
        >
            <div className="bg-white rounded-2xl shadow-lg w-full px-8 py-4" style={{ maxWidth: "450px" }}>
                ...
                <div className="mb-2">
                    ...
                    <div className="relative">
                        <FaUser className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={13} />
                        <input 
                            type="text" 
                            name="name" 
                            value={form.name} 
                ...
                {/* Email */}
                <div className="mb-2">
                    <label className="block text-gray-600 mb-0.5 text-xs">Correo electrónico</label>
                    <div className="relative">
                ...
                <div className="mb-2">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className={`${inputClass("password")} pl-8`} 
                            style={{ backgroundColor: "white" }} 
                        />
                    </div>
                ...
                {/* Confirmar Password */}
                <div className="mb-3">
                    <label className="block text-gray-600 mb-0.5 text-xs">Confirmar contraseña</label>
                    <div className="relative">
                        <FaLock className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={13} />
                        <input 
                            type="password" 
                            ...
                            placeholder="••••••••" 
                            autoComplete="new-password"
                            className={`${inputClass("confirmPassword")} pl-8`} 
                            style={{ backgroundColor: "white" }} 
                        />
                    </div>
